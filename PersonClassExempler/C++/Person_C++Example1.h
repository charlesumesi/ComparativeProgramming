...
void Person::just_firstandlast(std::string first, std::string last) {
  std::cout << first + " " + last;
}

void Person::full(std::string first, std::string last, std::string age, std::string gender, std::string interests) {
  std::string a = "is a";
